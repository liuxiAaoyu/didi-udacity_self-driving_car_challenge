...
//   }
  ...
  cv::Mat m_cam = (Mat_<double>(3,3) << 1384.621562, 0.000000, 625.888005,0.000000, 1393.652271, 559.626310,0,0,1);
  cv::Mat m_dist = (Mat_<double>(5,1) << 0, 0, 0, 0, 0);// -0.152089, 0.270168, 0.003143, -0.005640, 0.000000);
  cv::Mat m_rvecs = (Mat_<double>(3,1) << rx, ry, rz);//   1.18913633 -1.23253128 1.2014496  //1.20513633 -1.22253128 1.17414496  //1.18513633 -1.17253128 1.19414496
