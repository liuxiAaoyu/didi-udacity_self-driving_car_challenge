...
DEFAULT_FILE_DIR = '/home/xiaoyu/Documents/data/release/car./'
#DEFAULT_FILE_DIR = '/media/xiaoyu/B84E1E694E1E20A4/data/'
META_FILE_DIR = '/home/xiaoyu/Documents/data/release/car/training/'
...
class FeatureRecord:
    def __init__(self):
        ...
        self.outpath='/home/xiaoyu/Documents/data/release/car_train/'
        self.tracklet = None
        self.dict = None
        self.lwh = None
        self.name = None
    ...
    def dump(self):
        ...
        while num+500 < len(self.features):
            ...
            output=open(self.outpath+self.name+str(index)+'.pkl',"wb")
            pickle.dump(feature,output,2)
            num += 500
            index += 1
...
def callback(data):
    ...
    if commond == "first":
        ...
        trackletfile = DEFAULT_FILE_DIR + file_name + '/Tracklet.csv'
...
def test(msg):
    ...
    bbox=boundingbox
    feature=dict()
    if bbox[3]-bbox[1]>15 and bbox[2]-bbox[0]>15:
        print(bbox[0:4])
        #====================================================
