...
def tf_ssd_bboxes_encode_layer(labels,
    ...
    feat_orientations = tf.zeros(shape, dtype=dtype)
    ...
    def condition(i, feat_labels, feat_scores, feat_orientations,
    ...
    def body(i, feat_labels, feat_scores, feat_orientations,
             feat_ymin, feat_xmin, feat_ymax, feat_xmax):
        ...
        feat_orientations = fmask * orientation + (1 - fmask) * feat_orientations
        ...
        return [i+1, feat_labels, feat_scores, feat_orientations,
                feat_ymin, feat_xmin, feat_ymax, feat_xmax]
    # Main loop definition.
    i = 0
    [i, feat_labels, feat_scores, feat_orientations,
     feat_ymin, feat_xmin,
    ...
    return feat_labels, feat_localizations, feat_scores ,feat_orientations
    ...
    with tf.name_scope(scope):
        ...
        for i, anchors_layer in enumerate(anchors):
            with tf.name_scope('bboxes_encode_block_%i' % i):
                t_labels, t_loc, t_scores, t_orientations = \
                    tf_ssd_bboxes_encode_layer(labels, bboxes, orientations, anchors_layer,
                ...
                target_orientations.append(t_orientations)
        return target_labels, target_localizations, target_scores, target_orientations
